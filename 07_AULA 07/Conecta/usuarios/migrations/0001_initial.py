    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto_capa', models.ImageField(blank=True, null=True, upload_to='capas/')),
                ('tipo_conta', models.CharField(choices=[('pessoal', 'Pessoal'), ('business', 'Business'), ('creator', 'Creator')], default='pessoal', max_length=20)),
